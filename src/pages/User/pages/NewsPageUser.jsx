...
export const listNews = [
  {
    id: 1,
    title: 'Công đoàn khoa Công nghệ Thông tin tổ chức chuyến nghỉ mát hè 2023 và thăm Quê Bác',
    describe:
  ...
  return (
    <section className='bg-white py-4 md:py-8 lg:py-10 xl:py-12'>
      <div className='p-4 w-full md:w-[90%] mx-auto'>
        <h2 className='pl-6 md:pl-8 xl:mb-6 border-l-8 border-rootGreen uppercase text-rootGreen font-semibold text:xl md:text-2xl lg:text-3xl xl:text-4xl mb-4'>
          Tin tức học viện
        </h2>
  ...
  return (
    <section className='bg-white py-4 md:py-8 lg:py-10 xl:py-12'>
      <div className='p-4 w-full md:w-[90%] mx-auto'>
        ...
        <div className='mt-12'>
          <Pagination total={85} pageSizeOptions={[10, 20, 25]} defaultPageSize={10} defaultCurrent={1} responsive />
        </div>
      </div>
    </section>
  );
