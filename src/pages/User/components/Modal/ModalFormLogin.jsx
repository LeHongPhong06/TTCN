            ...
            return [
              <div className='flex justify-between w-full items-center'>
                <p
                  ...
                  className='opacity-50 font-saira italic hover:opacity-100 hover:text-rootGreen hover:cursor-pointer'
                >
                  Quên mật khẩu
                </p>
                <Space size={10}>
                  ...
                  ></ButtonCustom>
                  <ButtonCustom title='Hủy' key='cancel' handleClick={handleClickCancel}></ButtonCustom>
                </Space>
              </div>,
            ];
          },
