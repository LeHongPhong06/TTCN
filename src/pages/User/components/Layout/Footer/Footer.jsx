...
export function Footer(props) {
  return (
    <div>
      <footer className='flex w-full flex-col gap-6 md:flex-row justify-between p-4 md:p-6 lg:px-14 lg:py-8 border-b bg-rootGreen text-white '>
      ...
      <div className='flex bg-rootGreen py-1'>
