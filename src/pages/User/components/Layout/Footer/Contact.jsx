          ...
          <div className='flex-1 z-50'>
            ...
            <div className='flex-col xl:flex-row flex gap-3'>
              <div className='flex gap-2 md:gap-3 lg:gap-4 xl:gap-5 flex-col flex-1'>
                <Input
                  prefix={<MailOutlined className='mr-2 text-rootGreen' />}
                ...
                />
                <Input
                  prefix={<FormOutlined className='mr-2 text-rootGreen' />}
                  placeholder='Tiêu đề'
                  value={titleValue}
              ...
              <button className='flex-3 px-6 py-4 bg-rootGreen rounded-xl text-white hover:scale-105 active:scale-110 ease-in-out duration-300 max-h-[55px]'>
                Gửi đến chúng tôi
              </button>
            </div>
          </div>
