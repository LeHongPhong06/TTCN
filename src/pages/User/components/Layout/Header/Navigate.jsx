            ...
            <ul className='hidden md:flex lg:text-xl xl:text-[1.3rem] items-center gap-3 sm:gap-6 md:gap-8'>
              {links.map((item) => (
                <li
                  ...
                  className='relative text-black hover:text-rootGreen hover:opacity-80 hover:cursor-pointer ease-out duration-200 active:scale-95 after:absolute after:content-[""] after:w-0 after:h-[2px] after:bg-rootGreen hover:after:w-full after:left-0 after:right-0 after:bottom-0 py-3 after:transition-all after:duration-500 after:ease-in-out'
                >
                  {item.title}
                </li>
              ))}
