      ...
      {dataStudent && (
        <Descriptions bordered={true} layout='vertical' column={3}>
          ...
          <Descriptions.Item span={1} label='Khóa'>
            {dataStudent?.course?.id ? dataStudent?.course?.id : '[ Không có dữ liệu ]'}
          </Descriptions.Item>
